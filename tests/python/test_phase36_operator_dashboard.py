...
def _prepare_reports(root: Path) -> None:
    ...
    (root / "telemetry_repair" / "telemetry_timestamp_summary.json").write_text(json.dumps({"telemetry_status": "TELEMETRY_CLEAN", "telemetry_acceptance_clear": True}), encoding="utf-8")
